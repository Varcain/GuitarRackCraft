...
if(EXISTS "${_pa_dir}/MOD/manifest.ttl")
    configure_file("${_pa_dir}/MOD/manifest.ttl" "${_pa_assets}/manifest.ttl" COPYONLY)
else()
...
if(EXISTS "${_pa_dir}/MOD/modgui.ttl")
    configure_file("${_pa_dir}/MOD/modgui.ttl" "${_pa_assets}/modgui.ttl" COPYONLY)
endif()
if(IS_DIRECTORY "${_pa_dir}/MOD/modgui")
    file(COPY "${_pa_dir}/MOD/modgui/" DESTINATION "${_pa_assets}/modgui/")
endif()
...
# Prefer MOD/manifest.ttl because it includes rdfs:seeAlso <modgui.ttl>.
if(EXISTS "${_pwa_dir}/MOD/manifest.ttl")
    configure_file("${_pwa_dir}/MOD/manifest.ttl" "${_pwa_assets}/manifest.ttl" COPYONLY)
else()
...
if(EXISTS "${_pwa_dir}/MOD/modgui.ttl")
    configure_file("${_pwa_dir}/MOD/modgui.ttl" "${_pwa_assets}/modgui.ttl" COPYONLY)
endif()
if(IS_DIRECTORY "${_pwa_dir}/MOD/modgui")
    file(COPY "${_pwa_dir}/MOD/modgui/" DESTINATION "${_pwa_assets}/modgui/")
endif()
...
# Prefer MOD/manifest.ttl because it includes rdfs:seeAlso <modgui.ttl>.
if(EXISTS "${_pai_dir}/MOD/manifest.ttl")
    configure_file("${_pai_dir}/MOD/manifest.ttl" "${_pai_assets}/manifest.ttl" COPYONLY)
else()
...
if(EXISTS "${_pai_dir}/MOD/modgui.ttl")
    configure_file("${_pai_dir}/MOD/modgui.ttl" "${_pai_assets}/modgui.ttl" COPYONLY)
endif()
if(IS_DIRECTORY "${_pai_dir}/MOD/modgui")
    file(COPY "${_pai_dir}/MOD/modgui/" DESTINATION "${_pai_assets}/modgui/")
endif()
...
# Prefer MOD/manifest.ttl because it includes rdfs:seeAlso <modgui.ttl>.
if(EXISTS "${_pwai_dir}/MOD/manifest.ttl")
    configure_file("${_pwai_dir}/MOD/manifest.ttl" "${_pwai_assets}/manifest.ttl" COPYONLY)
else()
...
if(EXISTS "${_pwai_dir}/MOD/modgui.ttl")
    configure_file("${_pwai_dir}/MOD/modgui.ttl" "${_pwai_assets}/modgui.ttl" COPYONLY)
endif()
if(IS_DIRECTORY "${_pwai_dir}/MOD/modgui")
    file(COPY "${_pwai_dir}/MOD/modgui/" DESTINATION "${_pwai_assets}/modgui/")
endif()
